      ...
      <AnimatePresence mode="wait">
        {!isInitializing ? (
          <motion.div
            ...
            className="glass-panel p-10 rounded-3xl shadow-2xl border border-white/10"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-4 text-sm text-white placeholder:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-white/20 transition-all font-medium"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-white text-black py-4 rounded-xl font-black text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-3 hover:bg-zinc-200 transition-colors mt-8 group"
              >
                Initalize Session
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-center gap-4 text-[10px] font-bold text-zinc-500 uppercase tracking-[0.3em]">
                <span className={cn(progress > 20 ? "text-white" : "")}>Decrypting</span>
                <span>/</span>
                <span className={cn(progress > 50 ? "text-white" : "")}>Validating</span>
                <span>/</span>
                <span className={cn(progress > 80 ? "text-white" : "")}>Authorized</span>
              </div>
            </div>
            ...
            <p className="text-[9px] font-medium text-zinc-600 font-mono italic">
